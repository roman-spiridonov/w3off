...
default_keystore_file = (
    ...
    or os.path.join(os.path.dirname(os.path.abspath(__file__)), "test", "data", "keystore-test.json")
)
# default_keystore_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "test", "data","keystore-test2.json")  # 0x6f9bcfc0edb4057cda665e36d03b7d58e5926b04 | Vintage0!
