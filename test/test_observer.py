...
from observer.fetchABI import fetchABI, implementationAddress, listFunctions, isContract
from signer.checkOffline import checkOffline
from w3provider import change_chain, w3
from test.ethTesterContracts import aave_v3_ethtester, usdt_ethtester


class Test_fetchABI(unittest.TestCase):
    """Test caching and ABI fetching. NOTE: Some tests require Internet connectivity."""
    ...
    @patch("observer.fetchABI.implementationAddress")
    @patch("observer.fetchABI.fetchABI")
    @patch("observer.fetchABI.isContract")
