...
from helpers.abiHelpers import dataFromCall, encodeABICall, pad_hex
from helpers.addressHelpers import deployerToSmartContractAddress
from helpers.txHelpers import decodeRawTx, prepareDictToPrint
...
class TestTxHelpers(unittest.TestCase):
    ...
    def test_decodeRawTxType2(self):
        ...
        import test.data.txTestUSDTTransfer as t
