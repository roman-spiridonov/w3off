...
from cli_helpers import bcolors
...
def run_sender(signed_tx, **kwargs):
    ...
    if config.chain_name != "debug":
        ...
        while checkOffline():
            print(f"{cli_helpers.bcolors.UNDERLINE}You are offline!{cli_helpers.bcolors.ENDC} Make sure you connect back to the Internet.")
